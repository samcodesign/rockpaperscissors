...
def main():
    print("Beat me in Rock Paper Scissors 10 consecutive times to get the flag")
    for i in range(10):
        secret, rps = gen_commitments()
        move = rps[0][0]
        print("Possible commitments, the first one is my move:", " ".join(map(lambda s: s[1], rps)))
        inp = input("Your move xD:")
